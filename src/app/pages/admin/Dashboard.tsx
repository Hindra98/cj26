import { FileText, Image, Users, TrendingUp, Calendar, Square } from "lucide-react";
...
export function AdminDashboard() {
  ...
  const recentActivity = [
    ...
    { action: "Programme mis à jour", time: "Il y a 2 jours", type: "programme" },
  ];
  ...
  return (
    <div>
        ...
        {stats.map((stat, index) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-4xl mb-1" style={{ fontFamily: "'Playfair Display', serif" }}>
                {stat.value}
              </p>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            {recentActivity.map((activity, index) => (
              ...
              >
                ...
                >
                  {activity.type === "post" && <FileText size={18} color="white" />}
                  {activity.type === "photo" && <Image size={18} color="white" />}
                  {activity.type === "guest" && <Users size={18} color="white" />}
                  {activity.type === "programme" && <Calendar size={18} color="white" />}
                </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <FileText size={32} className="mx-auto mb-3 text-gray-400 group-hover:text-[#033720] transition-colors" />
            ...
            >
              <Image size={32} className="mx-auto mb-3 text-gray-400 group-hover:text-[#c95103] transition-colors" />
            ...
            >
              <Users size={32} className="mx-auto mb-3 text-gray-400 group-hover:text-[#cf6112] transition-colors" />
            ...
            >
              <Square size={32} className="mx-auto mb-3 text-gray-400 group-hover:text-[#d8a21e] transition-colors" />
      ...
      >
        ...
        <p>Le grand jour approche. N'oubliez pas de vérifier la liste des invités et le programme.</p>
      </motion.div>
    </div>
  );
}
